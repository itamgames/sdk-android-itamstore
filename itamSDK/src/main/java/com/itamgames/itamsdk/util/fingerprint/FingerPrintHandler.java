package com.itamgames.itamsdk.util.fingerprint;
...
public class FingerPrintHandler extends FingerprintManager.AuthenticationCallback {
    ...
    public void onAuthenticationSucceeded(FingerprintManager.AuthenticationResult result) {
        ...
        String encoded = mSharedPreferences.getString("KEY_PASSWORD", null);
        String decoded = FingerPrintUtil.decryptString(encoded, cipher);
//        iTamUtil.debugLog( "encoded : " + encoded );
//        iTamUtil.debugLog( "decoded : " + decoded );
